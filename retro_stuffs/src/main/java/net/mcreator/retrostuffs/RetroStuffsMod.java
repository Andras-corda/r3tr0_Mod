 ...
 *
 */
package net.mcreator.retrostuffs;
...
import net.mcreator.retrostuffs.init.RetroStuffsModTabs;
...
@Mod("retro_stuffs")
public class RetroStuffsMod {
	public static final Logger LOGGER = LogManager.getLogger(RetroStuffsMod.class);
	public static final String MODID = "retro_stuffs";

	public RetroStuffsMod() {
		...
		RetroStuffsModFeatures.REGISTRY.register(bus);
